...
from src.sentiment.sentiments import SentimentAnalysis
from flask import Blueprint, render_template

sentiment_blueprint = Blueprint("sentiment_blueprint", __name__, static_folder="../static", template_folder="../templates")
